  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const qr = await QRCode.toDataURL(modelUrl, {
        width: 300,
        margin: 2,
        color: { dark: '#14b8a6', light: '#0a0a0a' },
      })
      setQrDataUrl(qr)
    } catch (err: unknown) {
        ...
        {!result ? (
          ...
          >
            ...
            <div>
              ...
              <div
                className="border border-dashed border-steel-700 rounded-sm p-6 text-center cursor-pointer
                           hover:border-teal-500 transition-colors bg-arfab-black"
                onClick={() => fileInputRef.current?.click()}
              >
                {file ? (
                  <div>
                    <p className="text-teal-400 font-mono text-sm truncate">{file.name}</p>
            ...
            <div>
              ...
              >
                {ifcFile ? (
                  <div>
                    <p className="text-teal-400 font-mono text-sm truncate">{ifcFile.name}</p>
                    <p className="text-steel-500 font-mono text-xs mt-1">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-teal-500 hover:bg-teal-400 disabled:bg-steel-700 disabled:text-steel-500
          ...
          <div className="bg-steel-900 border border-steel-700 rounded-sm p-6 space-y-6">
            <div className="text-center">
              <div className="inline-block w-3 h-3 bg-teal-400 rounded-full mr-2" />
              <span className="text-teal-400 font-mono text-sm uppercase tracking-widest font-bold">
                Upload Successful
              </span>
            </div>
            ...
            {qrDataUrl && (
              <div className="text-center">
                ...
                <div className="inline-block border-2 border-teal-500 p-2 bg-arfab-black">
            ...
            <div className="flex flex-col gap-3">
              {qrDataUrl && (
                <a
                  ...
                  className="w-full bg-steel-800 border border-steel-600 hover:border-teal-500 text-steel-100
              ...
              <Link
                href="/dashboard"
                className="w-full bg-teal-500 hover:bg-teal-400 text-arfab-black font-mono font-bold
